...
export const Navigation = () => {
  ...
  return (
    <header className="w-full bg-slate-950 border-b border-slate-800/50 px-8 py-4 sticky top-0 z-50">
      <div className="max-w-[1600px] mx-auto flex items-center justify-between">
        ...
        <nav className="flex items-center gap-8">
          ...
          <div className="dropdown-container">
            ...
            <div className="dropdown-menu">
              <div className="bg-slate-900 border border-slate-800 rounded-lg shadow-xl py-2">
                <Link href="/services/data-engineering" className="block px-8 py-3 hover:bg-slate-800">
          ...
          <div className="dropdown-container">
            ...
            <div className="dropdown-menu">
              <div className="bg-slate-900 border border-slate-800 rounded-lg shadow-xl py-2">
                <Link href="/programs/aws-poc" className="block px-8 py-3 hover:bg-slate-800">
                ...
                <Link href="/programs/ai-assessment" className="block px-8 py-3 hover:bg-slate-800">
                  <p className="text-white font-medium text-sm">AI Blueprint</p>
                  <p className="text-slate-400 text-xs">For startups</p>
                </Link>
                <Link href="/programs/aws-map" className="block px-8 py-3 hover:bg-slate-800">
