        ...
        <div className="mt-12 p-8 bg-gradient-to-r from-violet-500/10 to-slate-900/60 border border-violet-500/30 rounded-xl text-center">
          ...
          <form className="flex gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-8 py-2 bg-slate-900/60 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-violet-500"
            />
            <button
              type="submit"
              className="px-8 py-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-violet-500 text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-medium"
            >
              Subscribe
            </button>
          </form>
