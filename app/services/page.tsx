...
export const metadata = {
  title: 'Services - PATHSDATA | AWS Select Tier Consulting Partner',
    ...
    <div className="py-16 px-8">
      <div className="max-w-[1600px] mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">End-to-End AWS</h1>
          <h2 className="text-4xl md:text-5xl font-bold"><GradientText>Consulting Services</GradientText></h2>
